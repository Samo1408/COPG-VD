...
public:
    ...
    void preAppSpecialize(zygisk::AppSpecializeArgs* args) override {
        ...
        // Device-wide hooks are intentionally independent of APP_PROFILES. Install them in
        // each app process after the framework classes can be resolved.
    ...
    void onLoad(zygisk::Api* api, JNIEnv* env) override {
        ...
        // Initialize LSPlant early. Framework classes are hooked after app specialization,
        // when the target classes are available in the process ClassLoader.
